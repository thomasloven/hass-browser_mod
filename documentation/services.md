...
|`adaptive`| Enable the popup to be an adaptive. A regular popup dialog will be used on larger screens while a bottom sheet will be used on smaller devices. NOTE: `classic` style is not compatible with adaptive dialog as it will never be used.|
