      ...
      <ha-card outlined>
        ...
        <div class="card-content">
          ...
          <ha-row-item>
            ...
            <ha-switch
              slot="end"
              .checked=${null===(h=window.browser_mod)||void 0===h?void 0:h.syncSession}
              @change=${this.toggleSyncSession}
              .disabled=${null===(u=window.browser_mod)||void 0===u?void 0:u.browser_locked}
            ></ha-switch>
          </ha-row-item>

          ${(null===(p=window.browser_mod)||void 0===p?void 0:p.registered)?K`
                ...
                <ha-row-item>
                  ...
                  <ha-switch
                    slot="end"
                    .checked=${null===(b=window.browser_mod)||void 0===b?void 0:b.cameraEnabled}
                ...
                <ha-row-item>
                  ...
                  <ha-switch
                    ...
                    .disabled=${null===(w=window.browser_mod)||void 0===w?void 0:w.browser_locked}
                  ></ha-switch>
                </ha-row-item>
                ${(null===(_=window.browser_mod)||void 0===_?void 0:_.cameraError)?K`
                    ...
                    `:""}
                ${(null===(v=window.browser_mod)||void 0===v?void 0:v.go2rtcError)?K`
                      <ha-alert alert-type="error">
    ...
    `}};e([ce()],xe.prototype,"hass",void 0),e([ce({type:Boolean})],xe.prototype,"dirty",void 0),e([ce({type:Boolean})],xe.prototype,"narrow",void 0),customElements.define("browser-mod-browser-settings-card",xe);class Ae extends ne{firstUpdated(){window.browser_mod.addEventListener("browser-mod-config-update",()=>this.requestUpdate()),this._fetch_entity_registry()}async _fetch_entity_registry(){this._entity_registry||(this._entity_registry=await this.hass.callWS({type:"config/device_registry/list"}))}_find_entity(e){if(this._entity_registry)return this._entity_registry.find(t=>{var i;return JSON.stringify(null===(i=null==t?void 0:t.identifiers)||void 0===i?void 0:i[0])===JSON.stringify(["browser_mod",e])})}unregister_browser(e){const t=e.currentTarget.browserID;window.browser_mod.showPopup({title:"Unregister browser",adaptive:!0,content:`Are you sure you want to unregister Browser ${t}?`,right_button:"Unregister",right_button_variant:"danger",right_button_appearance:"accent",right_button_action:()=>{t===window.browser_mod.browserID?window.browser_mod.registered=!1:window.browser_mod.connection.sendMessage({type:"browser_mod/unregister",browserID:t})},left_button:"Cancel",left_button_variant:"neutral",left_button_appearance:"plain",popup_styles:[{style:"all",styles:Se}]})}toggle_lock_browser(e){const t=e.currentTarget.browserID,i=window.browser_mod.browsers[t];window.browser_mod.connection.sendMessage({type:"browser_mod/register",browserID:t,data:Object.assign(Object.assign({},i),{locked:!i.locked})})}toggle_auto_register(e){var t;(null===(t=window.browser_mod)||void 0===t?void 0:t.global_settings.autoRegister)?window.browser_mod.setSetting("global",null,{autoRegister:void 0}):window.browser_mod.setSetting("global",null,{autoRegister:!0})}toggle_lock_register(e){var t;(null===(t=window.browser_mod)||void 0===t?void 0:t.global_settings.lockRegister)?window.browser_mod.setSetting("global",null,{lockRegister:void 0}):window.browser_mod.setSetting("global",null,{lockRegister:!0,autoRegister:void 0})}register_cast(){window.browser_mod.connection.sendMessage({type:"browser_mod/register",browserID:"CAST"})}render(){var e,t;return K`
      <ha-card header="Registered Browsers" outlined>
        <div class="card-content">
          ...
          ${Object.keys(window.browser_mod.browsers).map(e=>{const t=window.browser_mod.browsers[e],i=this._find_entity(e);return K` <ha-row-item>
              <span slot="headline">
